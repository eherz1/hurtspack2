...
echo "Launching forge-1.12.2-14.23.5.2859.jar with '$MEMORY' max memory, jvm args '$JVMARGS' and arguments '$LAUNCHARGS'"

$JAVAPATH -Xmx$MEMORY $JVMARGS  -Dlog4j2.formatMsgNoLookups=true -Dlog4j.configurationFile=log4j2.xml -jar forge-1.12.2-14.23.5.2859.jar "$LAUNCHARGS"
